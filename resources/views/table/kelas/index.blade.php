            ...
            <tbody>
              @foreach($kelas as $data)
                <tr>
                    ...
                    <td>
                        {{-- Edit --}}
                        <a href="/table/kelas/edit/{{ $data->id }}"  class="btn btn-outline-info btn-sm">
                        ...
                        {{-- Delete --}}
                        <form action="/table/kelas/destroy/{{ $data->id }}" method="POST" class="d-inline">
                          @csrf
