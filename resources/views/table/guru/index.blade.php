            ...
            <tbody>
              @foreach($guru as $data)
                <tr>
                    ...
                    <td>
                        {{-- Edit --}}
                        <a href="/table/guru/edit/{{ $data->id }}"  class="btn btn-outline-info btn-sm">
                        ...
                        {{-- Delete --}}
                        <form action="/table/guru/destroy/{{ $data->id }}" method="POST" class="d-inline">
                          @csrf
