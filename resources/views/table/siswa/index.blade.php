            ...
            <tbody>
              @foreach($siswa as $data)
                <tr>
                    ...
                    <td>
                        {{-- Edit --}}
                        <a href="/table/siswa/edit/{{ $data->id }}"  class="btn btn-outline-info btn-sm">
                        ...
                        {{-- Delete --}}
                        <form action="/table/siswa/destroy/{{ $data->id }}" method="POST" class="d-inline">
                          @csrf
