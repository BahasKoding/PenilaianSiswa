            ...
            <tbody>
              @foreach($jurusan as $data)
                <tr>
                    ...
                    <td>
                        {{-- Edit --}}
                        <a href="/table/jurusan/edit/{{ $data->id }}"  class="btn btn-outline-info btn-sm">
                        ...
                        {{-- Delete --}}
                        <form action="/table/jurusan/destroy/{{ $data->id }}" method="POST" class="d-inline">
                          @csrf
