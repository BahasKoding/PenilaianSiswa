            ...
            <tbody>
              @foreach($mengajar as $data)
                <tr>
                    ...
                    <td>
                        {{-- Edit --}}
                        <a href="/table/mengajar/edit/{{ $data->id }}"  class="btn btn-outline-info btn-sm">
                        ...
                        {{-- Delete --}}
                        <form action="/table/mengajar/destroy/{{ $data->id }}" method="POST" class="d-inline">
                          @csrf
