    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/table/mapel/store" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-floating mb-3">
                            <label for="floatingInput3">Nama Mapel</label>
                            <input required name="nama_mapel" type="text" required class="form-control" id="floatingInput3">
                        </div>
                       
                        <div class="input-group">
                            <a href="/table/mapel/index" class="btn btn-secondary rounded me-1">Kembali</a>
